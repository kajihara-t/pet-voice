...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      comment: "componentsからfeaturesへの依存を防ぐ",
      severity: "warn",
      from: {
        path: "^components/",
      },
    ...
    {
      name: "no-direct-hooks-usage",
      comment: "hooksは直接importせず、index.tsを経由する",
      severity: "warn",
      from: {},
      to: {
        path: "^hooks/(?!index)",
  ...
  options: {
    ...
    exclude: {
      /* path: an array of regular expressions in strings to match against */
      path: ["^node_modules", "^expo-env.d.ts", ".json$", ".config.", "^.expo"],
    },
...
// generated: dependency-cruiser@16.8.0 on 2024-12-30T10:14:49.885Z
